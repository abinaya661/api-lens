  ...
  return {
    ...
    offers: [
      ...
      },
      {
        ...
        description:
          'Unlimited keys, multiple seats for teams and agencies, downloadable reports, 15-minute usage sync. Invite only.',
        eligibleRegion: { '@type': 'Place', name: 'Worldwide' },
      ...
      },
      {
        ...
        description:
          'All Pro features billed annually. Save ~17% vs monthly. Invite only.',
        eligibleRegion: { '@type': 'Place', name: 'Worldwide' },
        availability: 'https://schema.org/PreOrder',
        url: `${SITE_URL}/signup`,
      },
