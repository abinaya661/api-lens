      ...
      <div className="flex flex-col items-center gap-2 text-center">
        ...
        >
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <path
              d="M10 2C5.58 2 2 5.58 2 10s3.58 8 8 8 8-3.58 8-8-3.58-8-8-8zm0 14a6 6 0 110-12 6 6 0 010 12z"
              fill="white"
              opacity="0.5"
            />
          </svg>
...
function GoogleIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
      ...
      />
      <path
        d="M8 16c2.16 0 3.97-.72 5.3-1.94l-2.59-2c-.71.48-1.63.76-2.71.76-2.08 0-3.84-1.4-4.47-3.29H.87v2.07A8 8 0 008 16z"
        fill="#34A853"
      />
      <path
        d="M3.53 9.53A4.8 4.8 0 013.28 8c0-.53.09-1.04.25-1.53V4.4H.87A8 8 0 000 8c0 1.29.31 2.51.87 3.6l2.66-2.07z"
        fill="#FBBC05"
      />
      <path
        d="M8 3.18c1.17 0 2.22.4 3.05 1.2l2.28-2.28A8 8 0 008 0 8 8 0 00.87 4.4l2.66 2.07C4.16 4.59 5.92 3.18 8 3.18z"
        fill="#EA4335"
      />
    </svg>
  )
