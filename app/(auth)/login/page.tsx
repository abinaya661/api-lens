    ...
    <div className="glass-card p-8 animate-fade-in">
      ...
      <div className="relative my-6">
        ...
        <div className="relative flex justify-center text-xs">
          <span className="bg-zinc-950 px-2 text-zinc-600">or continue with</span>
        </div>
      </div>

      <button
        onClick={handleGoogleLogin}
        className="w-full py-2.5 rounded-lg bg-zinc-900 border border-zinc-800 text-white text-sm font-medium
